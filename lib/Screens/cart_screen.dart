...
class _CartScreenState extends State<CartScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Total : " + (cart.cartTotal - couponDis).toString(),
                    style: TextStyle(
                      ...
                      if (isCouponApplied == true) {
                        ...
                        Navigator.push(
                          ...
                          PageTransition(
                            ...
                            child:
                            PaymentGateway(cart.cartTotal, disCountedAmount),
                          ),
                        );
                      } else {
                        Navigator.push(
  ...
  Widget getCartItems(List<Course> cartCourseList, List<BundleCourses> cartBundleList){
    ...
    return cartCourseList.length == 0 ? whenEmpty(mode) : Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _visible == false ? SizedBox.shrink() : cartCourseList.length == 0 &&
          cartCourseList.length == 0 ? SizedBox.shrink(): Container(
