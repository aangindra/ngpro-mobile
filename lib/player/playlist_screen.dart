                  ...
                  Expanded(
                    child: Text("${ lessClip.title}",
                      ...
                      style: TextStyle(
                          ...
                          color: mode.titleTextColor,
                          fontWeight:
                          currentVideo ? FontWeight.w800 : FontWeight.w400
                      )
                  ),
                  ),
                  currentVideo ? Icon(Icons.play_arrow, size: 40, color: mode.titleTextColor,) : Icon(Icons.play_arrow, size: 50,
...
//      ),
  ...
  void initState() {
    super.initState();
    print("Index: ${widget.clips}");
    fetchURLType(widget.clips[widget.defaultIndex].parent);
  }
