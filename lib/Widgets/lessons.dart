      ...
      if (element.type == "video"){
        if(element.url != null){
          ...
          if(element.iframeUrl != null){
            clips.add(VideoClip(element.title, "lecture", "images/ForBiggerFun.jpg",
                100, element.iframeUrl, element.id));
          }else{
            clips.add(VideoClip(element.title, "lecture", "images/ForBiggerFun.jpg",
                100, APIData.videoLink + element.video, element.id));
          }
        }
      }
    });
                ...
                child: IconButton(
                  onPressed: () {
                    if ((purchased || canView) &&
                        lessons[idx].type == "video" && lessons[idx].url != null) {
                        playVideo(idx);
                    }
                    else if((purchased || canView) && lessons[idx].type == "video" && lessons[idx].video != null){
                      playVideo(idx);
                    }else if((purchased || canView) && lessons[idx].type == "video" && lessons[idx].iframeUrl != null){
                      playVideo(idx);
                    }else{
                      return;
                    }
